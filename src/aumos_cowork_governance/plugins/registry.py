"""Plugin registry for aumos-cowork-governance.
...
"aumos_cowork_governance.plugins" group.
...
class PluginRegistry(Generic[T]):
    ...
    def load_entrypoints(self, group: str) -> None:
        ...
        ----------
        group:
            The entry-point group name, e.g. "aumos_cowork_governance.plugins".
        ...
        Then at runtime::
            ...
            registry.load_entrypoints("aumos_cowork_governance.plugins")
        """
