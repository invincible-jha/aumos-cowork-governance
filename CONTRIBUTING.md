# Contributing to aumos-cowork-governance

Thank you for contributing to aumos-cowork-governance, part of the AumOS portfolio.
...
```bash
git clone https://github.com/aumos-ai/aumos-cowork-governance.git
cd aumos-cowork-governance
pip install -e ".[dev]"
```
